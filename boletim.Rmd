...
# O Deflacionamento é feito colocando à preços de dezembro de 2018
...
receita_despesa_primaria %>%
  ...
  purrr::pluck("resultado_primario") -> resultado_primario_2020
```

O resultado primário do estado em 2020 foi de cerca de R\$ 1,47 bilhões, valor 18,8% maior que o resultado primário de 2019, quando foi pouco mais de R\$ 1,22 bilhões. Veja o Quadro [box:@resultado_primario] para mais detalhes sobre o resultado primário.
...
<!--chapter:end:cap_contaspublicas/main.Rmd-->
