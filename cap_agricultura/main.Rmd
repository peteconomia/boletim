...
```{r producao, fig.cap= "Produção Tocantins", fig.subcap="Em milhões de toneladas. Estimativa anual", fig.source = "IBGE", wrap = "open"}
...
```{r rendim_medio, fig.cap= "Rendimento médio das lavouras", fig.subcap="Mil quilogramas por hectare. Estimativa anual", fig.source = "SIDRA/IBGE"}
...
```{r area_plantada, fig.cap= "Área plantada das lavouras", fig.subcap="Em mil hectares. Estimativa anual", fig.source = "IBGE", wrap = "close"}
# Área Plantada
area_plan <- get_sidra(
  x = 6588,
  variable = 216,
...
```{r abates, fig.cap= "Abate dos principais animais", fig.subcap = "Mil cabeças", fig.source = "SIDRA/IBGE", wrap = TRUE}
