...
```{r rendim_medio, fig.cap= "Rendimento médio", fig.subcap="Saldo Anual", fig.source = "IBGE"}
...
```{r area_plantada, fig.cap= "Área Plantada", fig.subcap="Saldo Anual", fig.source = "IBGE", wrap = "close"}
# Área Plantada
