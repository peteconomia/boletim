...
receita_despesa_primaria <- rreo %>%
  ...
  mutate(
    receita_primaria_real = purrr::map2_dbl(ReceitasPrimariasCorrentes, data, ~ .x * ipca(.y, current_price)),
    despesa_primaria_real = purrr::map2_dbl(RREO6DespesasPrimariasCorrentes, data, ~ .x * ipca(.y, current_price)),
...
O resultado primário do estado em 2020 foi de cerca de R\$ 1,45 bilhões, valor 18,8% maior que o resultado primário de 2019, quando foi pouco mais de R\$ 1,22 bilhões. Veja o Quadro [@box:resultado_primario] para mais detalhes sobre o resultado primário.
