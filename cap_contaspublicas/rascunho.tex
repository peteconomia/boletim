...
As despesas com pessoal em relação a receita corrente líquida (\abbr{rcl}) encontra-se em 42,1\% em agosto
...
\footnote{A \abbr{rcl}, de acordo com a \abbr{lrf}, deve ser apurada somando-se as receitas arrecadadas no mês em referência e nos onze anteriores. No entanto, pelo fato  dessa publicação cobrir dados apenas do primeiro semestre, optou-se pela utilização da \abbr{rcl} acumulada até o respectivo bimestre}.
...
\abbr{dcl} aumentou em proporção à \abbr{rcl}, saindo de 30\% para
...
O indicador da capacidade de pagamento (\abbr{capag}) traz
...
endividamento do estado que representa a \abbr{dcl} em proporção à
