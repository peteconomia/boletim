...
```{r saldo, fig.cap= "Saldo de Empregos", fig.subcap="Saldo Anual", fig.source = "Ministério do trabalho", wrap = "open"}
...
```{r saldo_setor_to, fig.cap= "Saldo por setores", fig.subcap="XXXX", fig.source = "Ministério do trabalho"}
...
```{r pedido_segudo_desem, fig.cap= "Pedidos seguro-desemprego", fig.subcap="XXXX", fig.source = "IBGE", wrap = "close"}
...
```{r reg_emprego, fig.cap= "Regressão seguro desemprego/taxa de desemprego", fig.subcap="XXXX", fig.source = "PNAD-C", wrap = TRUE}
...
```{r tabela, fig.source = "Ministério do trabalho"}
# Tabelas
...
```{r taxa_desemprego, fig.cap= "taxa de desemprego", fig.subcap="XXXX", fig.source = "PNAD-C", wrap = "open"}
df <- get_sidra(
  x = 4092,
  geo = "State",
  header = T,
...
```{r rendimentos, fig.cap= "Rendimento médio mensal", fig.subcap="XXXX", fig.source = "PNAD-C"}
...
```{r pop_ocupada, fig.cap= "População ocupada", fig.subcap="XXXX", fig.source = "PNAD-C", wrap = "close"}
