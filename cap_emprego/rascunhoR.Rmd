...
```{r saldo_setor_to, fig.cap= "Saldo por setores", fig.subcap="XXXX", fig.source = "Caged"}
...
```{r pedido_segudo_desem, fig.cap= "Pedidos seguro-desemprego", fig.subcap="XXXX", fig.source = "YYYY", wrap = "close"}
...
```{r reg_emprego, fig.cap= "Regressão seguro desemprego/taxa de desemprego", fig.subcap="XXXX", fig.source = "YYYY", wrap = TRUE}
...
```{r taxa_desemprego, fig.cap= "taxa de desemprego", fig.subcap="XXXX", fig.source = "YYYY", wrap = "open"}
df <- get_sidra(
  x = 4092,
  geo = "State",
  header = T,
...
```{r rendimentos, fig.cap= "Rendimento médio mensal", fig.subcap="XXXX", fig.source = "YYYY"}
...
```{r pop_ocupada, fig.cap= "População ocupada", fig.subcap="XXXX", fig.source = "YYYY", wrap = "close"}
