...
```{r pib_demanda, fig.cap= "Variação trimestral do PIB pelo lado da demanda", fig.subcap="Com ajuste sazonal", fig.source = "IBGE", wrap = "open"}
...
```{r pib_oferta, fig.cap= "Variação trimestral do PIB pelo lado da oferta", fig.subcap="Com ajuste sazonal", fig.source = "IBGE", wrap = "close"}
