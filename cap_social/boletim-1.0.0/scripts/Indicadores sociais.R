...
ano <- c(2012,2013,2014,2015,2016,2017,2018,2019,2020)
...
gini_br <- c(0.540,0.533,0.526,0.524,0.537,0.538,0.545,0.543, 0.542)
gini_no <- c(0.544,0.541,0.518,0.525,0.523,0.530,0.551,0.537,0.537)
gini_to <- c(0.509,0.514,0.495,0.504,0.489,0.497,0.528,0.530,0.564)
