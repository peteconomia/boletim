...
Em relação a desigualdade de renda, percebe-se que houve uma redução no índice de Gini no estado ao longo dos anos apresentados, principalmente, entre os anos de 2019 e 2020 pode-se observar, o Gini caiu de 0,543 para 0,523 como mostra a Figura [fig:@gini]. Diferente dos outros indicadores apresentados até então, esse mostra uma redução para a Região Norte, Tocantins e Brasil.
