...
graf_taxas <- ggplot(tx_pob, aes(x = ano))+
  geom_line(aes(y = tx_pob_no, colour = "Norte"), size = 1.5)+
  geom_line(aes(y = tx_pob_to, colour = "Tocantins"), size = 1.5)+
  geom_line(aes(y = tx_pob_br, colour = "Brasil"), size = 1.5)+
  geom_point(aes(y = tx_pob_no, colour = "Norte"), size = 4)+
  geom_point(aes(y = tx_pob_to, colour = "Tocantins"), size = 4)+
  geom_point(aes(y = tx_pob_br, colour = "Brasil"), size = 4)+
  scale_colour_manual(
    values = c("Brasil"="#9ECAE1","Norte"="#4292C6","Tocantins"="#084594"))+
...
graf_taxas2 <- ggplot(tx_expob, aes(x = ano))+
  geom_line(aes(y = tx_expob_br, colour = "Brasil"), size = 1.5)+
  geom_line(aes(y = tx_expob_no, colour = "Norte"), size = 1.5)+
  geom_line(aes(y = tx_expob_to, colour = "Tocantins"), size = 1.5)+
  geom_point(aes(y = tx_expob_no, colour = "Norte"), size = 4)+
  geom_point(aes(y = tx_expob_to, colour = "Tocantins"), size = 4)+
  geom_point(aes(y = tx_expob_br, colour = "Brasil"), size = 4)+
  scale_colour_manual(
    values = c("Brasil"="#9ECAE1","Norte"="#4292C6","Tocantins"="#084594"))+
  scale_y_continuous(labels=percent_format(accuracy = 1))+
  scale_x_continuous(labels = ano, breaks = ano)
...
graf_gini <- ggplot(gini, aes(x = ano))+
  geom_line(aes(y = gini_br, colour = "Brasil"), size = 1.5)+
  geom_line(aes(y = gini_no, colour = "Norte"), size = 1.5)+
  geom_line(aes(y = gini_to, colour = "Tocantins"), size = 1.5)+
  geom_point(aes(y = gini_no, colour = "Norte"), size = 4)+
  geom_point(aes(y = gini_to, colour = "Tocantins"), size = 4)+
  geom_point(aes(y = gini_br, colour = "Brasil"), size = 4)+
  scale_colour_manual(
    values = c("Brasil"="#9ECAE1","Norte"="#4292C6","Tocantins"="#084594"))+
  scale_x_continuous(labels = ano, breaks = ano)
graf_gini
...
#Número de pobres (linha US$5,50 PPC por dia)
...
graf_pobs_br <- ggplot(pobs, aes(x = ano))+
  ...
  labs(x = "Ano", y = "Número de Pobres",
       title = "Número de Pobres no Brasil (1000 pessoas)",
...
graf_pobs_no <- ggplot(pobs, aes(x = ano))+
  ...
  labs(x = "Ano", y = "Número de Pobres",
       title = "Número de Pobres no Norte",
       subtitle = "Linha de US$5,50 PPC por dia",
       caption = "Fonte: IBGE(2019)")
graf_pobs_no
...
graf_pobs_to <- ggplot(pobs, aes(x = ano))+
  ...
  labs(x = "Ano", y = "Número de Pobres",
       title = "Número de Pobres no Tocantins",
       subtitle = "Linha de US$5,50 PPC por dia",
       caption = "Fonte: IBGE(2019)")
graf_pobs_to
...
graf_pobs_pmw <- ggplot(pobs, aes(x = ano))+
  ...
  labs(x = "Ano", y = "Número de Pobres",
       title = "Número de Pobres em Palmas",
       subtitle = "Linha de US$5,50 PPC por dia",
       caption = "Fonte: IBGE(2019)")
graf_pobs_pmw
...
graf_expobs_br <- ggplot(expobs, aes(x = ano))+
  ...
  labs(x = "Ano", y = "Número de Extremamente Pobres",
       title = "Número de Extremamente Pobres no Brasil (1000 pessoas)",
...
graf_expobs_no <- ggplot(expobs, aes(x = ano))+
  ...
  labs(x = "Ano", y = "Número de Extremamente Pobres",
       title = "Número de Extremamente Pobres no Norte",
       subtitle = "Linha de US$1,90 PPC por dia",
       caption = "Fonte: IBGE(2019)")
graf_expobs_no
...
graf_expobs_to <- ggplot(expobs, aes(x = ano))+
  ...
  labs(x = "Ano", y = "Número de Extremamente Pobres",
       title = "Número de Extremamente Pobres no Tocantins",
       subtitle = "Linha de US$1,90 PPC por dia",
       caption = "Fonte: IBGE(2019)")
graf_expobs_to
...
graf_expobs_pmw <- ggplot(expobs, aes(x = ano))+
  ...
  labs(x = "Ano", y = "Número de Extremamente Pobres",
       title = "Número de Extremamente Pobres em Palmas",
       subtitle = "Linha de US$1,90 PPC por dia",
       caption = "Fonte: IBGE(2019)")
graf_expobs_pmw
...
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/pobreza.jpg", 
#      plot = graf_taxas)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/extrema_pobreza.jpg", 
#      plot = graf_taxas2)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/gini.jpg", 
#       plot = graf_gini)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/ren.jpg", 
#       plot = graf_ren_cor)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/pobres_br.jpg", 
#       plot = graf_pobs_br)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/pobres_no.jpg", 
#       plot = graf_pobs_no)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/pobres_to.jpg", 
#       plot = graf_pobs_to)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/pobres_pmw.jpg", 
#      plot = graf_pobs_pmw)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/expobres_br.jpg", 
#       plot = graf_expobs_br)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/expobres_no.jpg", 
#       plot = graf_expobs_no)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/expobres_to.jpg", 
#       plot = graf_expobs_to)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/expobres_pmw.jpg", 
