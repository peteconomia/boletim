...
#e em relação ao trimestre anterior)
...
#Variação do total do PIB em relação ao trimestre anterior(dessazonalizado)
graf_pib_an <- ggplot(var_pib_an, aes(x=Trimestre, y = Valor))+
  geom_bar(stat="identity", position = "position", fill="#08519C", width = 0.3)+
  scale_x_discrete(labels=c("202001"="1°tri 2020","202002"="2°tri 2020",
                            "202003"="3°tri 2020"))+
  geom_text(aes(label = paste(Valor),vjust = ifelse(Valor >= 0, -0.3, 1)),
            position = position_dodge(width = 0.7),size=4, show.legend = FALSE)+
  labs(caption = "Fonte: IBGE")
...
graf_da <- ggplot(new_da, aes(x=Setores_e_subsetores, y = Valor, fill = Trimestre))+
  ...
  geom_text(aes(label = paste(Valor),vjust = ifelse(Valor >= 0, -0.2, 1)),
            position = position_dodge(width = 0.7),size=3.6, show.legend = F) +
  labs(caption = "Fonte: IBGE")
graf_da
...
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/pib_ac.jpg", 
#      plot = graf_pib_ac)
ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Instagram PET/pib_an.pdf", 
      plot = graf_pib_an)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/demanda.jpg", 
#       plot = graf_da)
#ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Boletim/oferta.jpg", 
#       plot = graf_oferta)
ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Instagram PET/demanda.jpg", 
       plot = graf_da_an)
ggsave(filename = "C:/Users/lucas/OneDrive/Área de Trabalho/Instagram PET/oferta.jpg", 
       plot = graf_oferta_an)
