...
\begin{figure}[h]
	...
	\includegraphics[width=\linewidth]{fig/Rendimento médio.pdf}
	\source{IBGE/SIDRA}
	\notes{Relação por trimestre a partir do 1T de 2019 para a produtividade no campo.}
\end{figure}
...
\begin{figure}[h]
	\caption{Abate de Bovinos - Tocantins}
	\includegraphics[width=\linewidth]{fig/Bovinos.pdf}
	\source{IBGE/SIDRA}
	\notes{Relação por trimestre a partir do 1T de 2019 para acompanhar o movimento que os empregos estão tendo.}
\end{figure}

\begin{figure}[h]
	\caption{Abate de Vacas - Tocantins}
	\includegraphics[width=\linewidth]{fig/Vacas.pdf}
	\source{IBGE/SIDRA}
	\notes{Relação por trimestre a partir do 1T de 2019 para acompanhar o movimento que os empregos estão tendo.}
\end{figure}

\begin{figure}[h]
	\caption{Abate de Novilhas - Tocantins}
	\includegraphics[width=\linewidth]{fig/Novilhas.pdf}
	\source{IBGE/SIDRA}
	\notes{Relação por trimestre a partir do 1T de 2019 para acompanhar o movimento que os empregos estão tendo.}
\end{figure}
