...
extrafont::loadfonts()
petgg::set_theme(base_family = "Times New Roman")
...
# sem dados para suinos
# abate_suino <- get_sidra(x = 1093,
# 		period = c("201903", "202001", "202002"),
# 		geo = "State",
# 		geo.filter = list("State" = 17),
# 		header = TRUE,
# 		format = 4
...
triForm <- function(x) paste0(substr(x, 6, 6),"T/",substr(x, 1, 4))
...
bind_rows(
	...
	ggplot(aes(factor(tri, levels = c("3T/2019", "4T/2019", "1T/2020", "2T/2020")), Valor, fill = tipo)) +
