...
\begin{smbox}[label={labelbox},nameref={Desigualdade por gênero}]{Desigualdade por gênero}
	Já é um tópico bem usual que o mercado de trabalho formal é um quanto desigual para as mulheres, existe uma vasta literatura sobre desigualdades salarias, vagas de empregos, oportunidades, etc. O estudo de XXX\footnote{Referencia do Estudo} e YYY\footnote{Referencia do Estudo 2} fazem um bom estudo e mais aprofundado sobre estas desigualdades.
\end{smbox}
